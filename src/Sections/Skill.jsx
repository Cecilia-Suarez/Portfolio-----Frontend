...
const Skill = () => {
    ...
    return (
        <div id='skills' className='flex flex-col items-center animate-slideInRight'>
            <h2 className='text-3xl animate-fadeIn mb-6'>Skills</h2>
            <div className='grid lg:grid-cols-5 sm:grid-cols-3 justify-center max-w-3xl mx-auto gap-x-2 gap-y-4'>
